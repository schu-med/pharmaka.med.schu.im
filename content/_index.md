...
| Indirekte Antikoagulantien | Heparine | Niedermolekulare Heparine NMH (bspw. Tinzaparin, Dalteparin, Enoxaparin) | Komplexbildung mit Antithrombin -> Inaktivierung von Xa > IIa | Thromboseprophylaxe, ACS, DIC, Dialyse | Blutungsrisiko, HIT, Osteoporose | | HIT II | |
...
| Direkte Antikoagulantien | Neue orale Antikoagulantien (NOAK) bzw. Direkte orale Antikoagulantien (DOAK) | Dabigatran (Handelsname: Pradaxa) | Direkter Thrombin-Inhibitor, reversibel und kompetitiv | TVT (Tiefe Venenthrombose), Vorhofflimmern | Blutungsrisiko, LI, NI | | | Antidot: Idarucizumab |
| Direkte Antikoagulantien | NOAK, DOAK | Rivaroxaban (Handelsname: Xarelto), Apixaban (Handelsname: Eliquis), Edoxaban (Handelsname: Lixiana) | Direkter Faktor Xa Inhibitor, reversibel und kompetitiv  | TVT (Tiefe Venenthrombose), Vorhofflimmern | Blutungsrisiko, LI, NI | | | Antidot: Andexanet alfa |
| Direkte Antikoagulantien | | Argatroban | Thrombin-Inhibitor | Thromboseprophylaxe bei HIT-2 | | | | |
...
| Sympatholytika | alpha-Blocker | Phentolamin | kompetetiver Blocker | | | | | |
...
| Herzglykoside (aka Digitalisglykoside oder Digitalis) | Cardenolide | Digoxin, Digitoxin | Hemmung der Na-K-ATPase -> mehr Na intrazellulär -> **positiv inotrop, negativ dromotrop** | HI, tachykardes Vorhofflimmern | | | | |
...
| Antikörper | | Teprotumumab | | endokrine Orbithopathie (Bindung an IGF-1 Rezeptor) | | | | |
| Antikörper | Checkpoint-Inhibitor, CTLA-4-Inhibitor | Ipilimumab | | | | | | |
| Antikörper | Checkpoint-Inhibitor, PD-1-AK | Nivolumab, Pembrolizumab | | | | | | |
| Antikörper | Checkpoint-Inhibitor, PD-L1-AK | Durvalumab, Atezolizumab | | | | | | |
...
| Antipsychotika (Neuroleptikum) | Butyrophenone | Haloperidol (Handelsname: Haldol) | hochpotent, Dopamin-D2-Antagonist | Schizophrenie, (manische) Psychosen, Erregung | oft schwere motorische NW, EPS | | | |
| Antipsychotika (Neuroleptikum) | | Levomepromazin, Thioridazin, Chlorprothixen, Sulpirid | niederpotent, Dopamin-D2-Antagonist | | (EPS) | | | |
| Antipsychotika (Neuroleptikum) | | Chlorpromazin | Dopamin-D1- und D2-Antagonist | | (EPS) | | | |
...
| Dopamin-Agonisten | | Pramipexol, Ropinirol, Rotigotin | | | Restless-Legs-Syndrom (RLS) | | | |
...
| Nicht-Opioid Analgetika | Antipyretisch, Analgetisch | Metamizol (Handelsname: Novalgin) | unselektiv COX1/COX2, **spasmolytisch** | Koliken der Galle- und ableitenden Harnwege, Tumorschmerzen, Therapie-resistentes Fieber, akute/chronische Schmerzen wenn Mangel an Therapiealternativen | **Agranulozytose**, Anaphylaktischer Schock bei oraler Gabe, **Blutdruckabfall** | | | |
| Nicht-Opioid Analgetika | Antipyretisch, Analgetisch | Phenazon (Handelsname: Antipyrin) | | | | | | |
...
| RAAS Inhibitoren | Angiotensin-II-Antagonisten (AT1-Rezeptor-Blocker(!), Sartane) | Suffix *-sartan*, Valsartan | Bindung an AT1-Rezeptor (ein G-Protein-gekoppelter Rezeptor, Gq + Gi) -> Senkung cAMP und Aktivierung der Phospholipase C | Hypertonie, HI, **diabetische Nepropahtie**, ACE-Hemmer-Unverträglichkeit | Hyperkaliämie, GFR reduziert | | NI, Nierenstenose, Schwangerschaft | |
| RAAS Inhibitoren | Aldosteron Antagonisten / Kalium-sparende Diuretika | Spironolacton, Eplerenon, Canrenon (aka Canreonat) | hemmt Wirkung von Aldosteron | Hyperaldosteronismus, HI NYHA 2 + 3, Leberzirrhose (Aszites, periphere Ödeme) | Hyperkaliämie, Amenorrhoe, Gynäkomastie (nicht Eplerenon, das als NW-arm gilt) | | Hyperkaliämie, Hyponatriämie, Hypovolämie, NI, Schwangerschaft | Nicht für antihypertensive Therapie zugelassen! |
| Neprilysin-Inhibitor | | Sacubitril (in fester Kombination mit Valsartan Handelsname: Entresto) | Neprilysin baut u.a. ANP und BNP ab, Sacubitril inhibiert indirekt diesen Abbau | Bei HI **in Kombination mit Valsartan** | | | | Die Kombination Sacubitril/Valsartan gilt als ein **Angiotensinrezeptor-Neprilysin-Antagonist (ARNI)** |
| Calcium-Kanalblocker | Dihydropyridin (DHP-CCB) | Suffix *-dipin*, Nifedipin, Nitrendipin, Nisoldipin, Amlodipin, Felodipin, Nimodipin | Wirkung auf vaskuläre glatte Muskulatur (L-Typ Ca-Kanal) | Hypertonie, stabile AP, vasospastische AP, Raynaud-Syndrom | Reflex-Tachykardie, Kopfschmerzen, Flush, Wärmegefühl, Schwindel, Müdigkeit, **Beinödeme** (die nicht auf Diuretika ansprechen) | Andere Hypertensiva, CYP3A4 | | **Nifedipin unretadiert nicht als Monotherapie bei Hypertension**, da nur kurz wirksam und schnell anflutend -> Reflextachykardie |
...
| Diuretika | Schleifendiuretika | Furosemid (Handelsname: Lasix), Bumetanid, Torasemid, Piretanid, Etacrynsäure | luminale Inhibition des Na+/K+/Cl-- Cotransporter -> gesteigerte Exkretion, geringere H2O Absorption, erhöhte Mg++ und Ca++ Ausscheidung, verringerte Harnkonzentration, Erhöhung der Ausscheidung um bis zu 30-40% des Glomerulusfiltrats | Ödeme bei HI/NI, Lungenödem, Hypertensive Krise, Intoxikation  (forcierte Diurese) | Hypovolämie, Dehydration, Hypotonie, bei längerer Gabe auch: Hypokaliämie, verminderte Glukosetoleranz, Hyperglykämie, ... | Blutdruck-senkene Pharmaka, oto-/nephrotoxische Pharmaka (würde verstärkt werden), Digitalis (bei Hypokaliämie), Corticosteroide und Laxantien, NSAR, Lithium, Antidiabetike, Harnsäure-senkende Pharmaka | LI, Hyponatriämie, Hypokaliämie, Hypovolämie, Schwangerschaft, Gicht, Sulfonamidallergie | **Vorteil des Torasemid: nur zu ca. 15% renal eliminiert** -> Risiko einer Kumulation bei NI gering |
| Diuretika | Thiazide | Hydrochlorothiazid, Bendroflumethiazid, Chlortalidon, Xipamid, Metolazon, Indapamid, ... | Inhibition des Na+/Cl- Cotransporter im frühdistalen Tubulus, Erhöhung der Ausscheidung um 8-10% der GFR, Abfall der GFR, längere HWZ, **Chlortalidon mit Wirkdauer von 48-72h und HWZ von 35-54h** | arterielle Hypertonie, chron. HI (NYHA I), Ödeme bei akuter HI, Lungenödem, Hyperkalziurie, Intoxikation (forcierte Diurese) | Hypokaliämie, Hypomagnesiämie, Harnsäureretention, **Hyperglykämieneigung**/geringe Glukosetoleranz (vermutet wird Insulinsenkung), Hyperkalziämie, **Hydrochlorothiazid: erhöhtes Hautkrebs-(Nicht-Melanom-)-Risiko** | wie bei Schleifendiuretika ^^^ | **NI**, LI, Sulfonamidallergie, Hyperkalziämie, Hypokaliämie, Hyponatriämie, Schwangerschaft | **Indapamid** ist ausschließlich zur Behandlung einer Hypertonie zugelassen. |
| Diuretika | Na-Kanal-Inhibitoren / Kalium-sparende Diuretika | Amilorid, Triamteren | Hemmt ENaC, reduziert folglich auch K+ Sekretion, 3% der GFR | Kardiale, renale und hepatische Ödeme, HI, Hypertonie, Kombinationspartner der Diuretika-Therapie zur Reduzierung von K+ Verlusten | Hyperkaliämie, GI, Impotenz | Blutdruck-senkende Pharmaka, Kalium und ACE-Hemmer, andere K+ sparende Diuretika, Digitalis, Lithium, NSAR | Hyperkaliämie, Hyponatriämie, Hypovolämie, NI, Schwangerschaft, Stillzeit | |
...
| Diuretika | V2-Rezeptorantagonisten (Vaptane) | Tolvaptan | | Hyponatriämie als sekundäre Folge des Syndroms der inadäquaten ADH Sekretion (SIADH), autosomal-dominante polyzystische Nierenerkrankung (ADPKD) | rasche Anstieg des Na-Spiegel, Durst, Übelkeit, Hypernatriämie, Hyperurikämie, selten Leberschädigung | | | |
| Antidiuretika | ADH-Analogon | Desmopressin | Analogon des körpereigenen Hormons Adiuretin (ADH), vermehrte Freisetzung von von-Willebrand-Faktor aus Endothelzellen (konsekutiv auch Freisetzung von Faktor VIII aus Speichern der Endothelzellen) | Diabetes insipidus centralis, Gerinnungsstörung | | | | |
...
| Antibiotika | Aminoglykoside | Gentamicin (aka Gentamycin), Amikacin, Tobramycin, Paromomycin, Streptomycin | Bindung an 30S-UE, bakterizid (primär) | (G+), G-, **nur Aerobier**; in Kombination mit einem Betalaktamantibiotikum, mit Ampicillin bei Listerien-Meningitis | Nephrotoxizität, Ototoxizität | Res.: Veränderung des AB (Acetylierung) | | bei lebensbedrohlichen Infektionen in Kombination mit beta-Lactam-AB |
...
| Antibiotika | Ansamycine | Rifampicin | Hemmung der DNA-abhängigen RNA-Polymerase (i.e. der Transkription) | G+, atypische, **M. tuberculosis**, Rifampicin zur Prophylaxe bei Meningokokken-Meningitis im sozialen Umfeld | GI, Thrombozytopenie, Hepatotoxizität, Neurotoxizität | CYP-Induktionen mit Interaktionspotenzial (v.a. CYP3A4, CYP2C9) | LI, Schwangerschaft, Stillzeit | Reserve-AB |
| Antibiotika | Fluorchinolone | Levofloxacin, Ciprofloxacin, Moxifloxacin | DNA/RNA-Hemmstoffe, Hemmung der Gyrase (Topoisomerase II und IV) | (G+), G-, atypische, Ciprofloxacin zur Prophylaxe bei Meningokokken-Meningitis im sozialen Umfeld | GI, Neurotoxizität, Tendo-/Arthropathie, CYP1A2 Hemmung, **QT-Zeit-Verlängerung** | Res.: Aktiver Auswärtstransport ("Effluxpumpe"), veränderte Topoisomerase | | |
| Antibiotika | Nitroimidazole | Metronidazol (Handelsname: Clont) | DNA-Schädigung durch reaktive Metaboliten (anaerob) | Aa, Protozoen | Neuropathie, Geschmacksstörungen, Alkoholunverträglichkeit| Res.: Stoffwechseländerung, Inaktivierung der Metaboliten | | |
| Antibiotika | Nitrofurane | Nitrofurantoin, Nitrofural | DNA-Schädigung durch reaktive Metaboliten | G+, G- | allergische pulmonale Infiltration, GI, Hepatotoxizität| Res.: Stoffwechseländerung, aktiver Auswärtstransport | | |
| Antibiotika | Folsäuresynthesehemmer | Sulfonamide (Sulfamethoxazol, Sulfadiazin), Trimethoprim (in Kombination: Cotrimoxazol) | Hemmung der Tetrahydrofolsäure-Synthese, bakteriostatisch | (G+), (G-), Therapie von durch Protozoen (e.g. Toxoplasma gondii, Plasmodien) verursachten Krankheiten, **Pneumocystis jiroveci** | Hautreaktionen, Photosensibilisierung, Blutbildungsstörung | Res.: veränderte Enzyme | Sulfonamid-Allergie, LI, NI, Porphyrien, Favismus, Schwangerschaft, Stillzeit, Neugeborene | wird hochdosiert zur Therapie von Pneumocystis-jirovecii-Pneumonie eingesetzt |
| Antibiotika | Makrozykline | Fidaxomicin | | **Clostridioides-difficile-Infektion / -assoziierte Diarrhoe (CDAD)**, pseudomembranöse Colitis | | | | |
| Antibiotika | Folsäuresynthesehemmer (PABA-Analoga) | Dapson | | Lepra | | | | |
...
| Antiprotozoikum | | Melarsoprol, Suramin, Nifurtimox, Benznidazol, Pentamidin | | Chagas-Krankheit | | | | |
...
| Zytostatika | Platinverbindungen | Cisplatin, Carboplatin, Oxaliplatin | Alkylierung von DNA/RNA -> Vernetzung und Strangbrüche | | | | | |
...
| Zytostatika | Hydroxyharnstoffe | Hydroxycarbamid (Hydroxyurea, Hydroxyharnstoff) | | myeloproliferative Erkrankungen, Erhöhung der Strahlensensitivität | KM-Depression, Megaloblastose | | | |
...
| | | Arsentrioxid (ATO, Handelsname: Trisenox) | | | | | | |
...
| Signalweg-Inhibitoren | CDK-Inhibitor | Palbociclib | | Mamma-Ca (HER2-negativ) | | | | |
...
| Orale Antidiabetika | SGLT2-Inhibitoren | Dapagliflozin, Canagliflozin, Empagliflozin, Suffix *-gliflozin* | verhindern Glukoseresorption im proximalen Konvolut aus Primärharn, geringes Hypoglykämie-Risiko | HbA1c Senkung um 0,7-0,8%, Gewichtsabahme, Blutdrucksenkung | HWI, GI, Fournier-Gangrän | | NI, Überempfindlichkeit | |
...
| Orale Antidiabetika | Glitazone (aka Thiazolidindione, Insulin-Sensitizer) | Pioglitazon, Rosiglitazon, uvm. | Senkung der Insulin-Resistenz | | | | | In Deutschland nicht mehr erstattungsfähig. |
...
| Antiemetika | Dopamin-Antagonist | Metoclopramid (MCP, Handelsname: Paspertin) | auch antagonistisch an 5-HT3 | u.a. Akuttherapie bei Migräne-Attacke | EPS | | | |
...
| Enkephalinase-Inhibitoren | | Racecadotril | | Diarrhoe | | | | |
...
| Gonadotropine | FSH | Follitropin alpha (rekombinant), Follitropin beta (rekombinant), Urofollitropin (Extrakt, gereinigt) | | | | | | |
...
| Gestagene | Norgestrel-Derivate (Gonane) | Levonorgestrel, Desogestrel | androgene Wirkung | Kontrazeption | | | | |
...
| Lipidsenker | HMG-CoA-Reduktase Hemmer (CSE Cholesterin-Synthese-Enzym Hemmer, Statine) | Lovastatin, Simvastatin, Atorvastatin, Cerivastatin, Rosuvastatin, Fluvastatin, Pravastatin | Hemmung der HMG-CoA-Reduktase -> Reduktion des verfügbaren Cholesterin -> positiver Effekt auf Gefäße | | Konzentrationsschwäche, Schlafstörungen, Hepatitis / Erhöhung Leberwerte, Impotenz, GI, Myopathien bis hin zu Rhabdomyolyse, **Transaminaseerhöhung (i.e. erhöhter Aminotransfer)** | Statine werden über CYP3A4 verstoffwechselt mit folgenden Ausnahmen: Fluvastatin wird über CYP2C9 verstoffwechselt, Rosuvastatin über CYP2C9/CYP2C19, Pravastatin keine Verstoffwechslung via CYP | LI, Myopathien, Schwangerschaft, Kinder | Verdopplung der Dosis führt zu ca. 6% LDL-Reduktion |
| Lipidsenker | Cholesterin-Resorptionshemmer | Ezetimib (Prodrug) | Hemmer des NPC1L1-Transporters (NPC1L1: *Niemann-Pick C1 like 1*); Reduktion des Cholesterin-Spiegel um bis zu 20% | | Kopf- und Bauchschmerzen, Diarrhoe | Colestyramin und Antazida reduzieren Wirkung | | |
...
| Lipidsenker | PCSK9-Inhibitoren | Inclisiran | | | | | | |
...
| Chelatbildner | | Dimercaptopropansulfonsäure (DMPS), Deferoxamin, Penicillamin | Chelatbildung -> schnelle renale Elimination | DMPS: Schwermetalle, Quecksilber; Deferoxamin: Eisen | | | | |
| Chelatbildner | | Dimercaprol | | Schwermetalle | | | CAVE: Quecksilber | |
...
| Urikosurikum | | Benzbromaron, Probenecid | | | | | | |
